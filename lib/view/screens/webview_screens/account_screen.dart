...
/// Account screen that displays the account deletion webview content
/// 
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  // Account URL
  static const String _accountUrl = 'https://www.glamorebijoux.ch/pages/request-account-deletion';
