class Changes {
  // main website url
  static String mainUrl = 'https://app.standheizung-auto.de';

  // if app start with this navigate else block or opens in external
  static String startPointUrl = 'https://app.standheizung-auto.de';
  ...
  static String AppTitle = 'AutoHeat';
  //one signal
  static String oneSignalAppId = 'aebfba42-ac2a-49ea-b8d9-bfff0f9dca3a';
